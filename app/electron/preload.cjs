...
contextBridge.exposeInMainWorld('rcloneSyncer', {
  ...
  cancelSync: (id, force) => ipcRenderer.invoke('sync:cancel', id, force),
  ...
  reconnectRemote: (name) => ipcRenderer.invoke('remote:reconnect', name),
  aboutRemote: (name) => ipcRenderer.invoke('remote:about', name),
  dismissAdvisory: (id) => ipcRenderer.invoke('advisory:dismiss', id),
  checkEngineUpdate: () => ipcRenderer.invoke('engine:check-update'),
  updateEngine: (version) => ipcRenderer.invoke('engine:update', version),
  resetEngine: () => ipcRenderer.invoke('engine:reset'),
